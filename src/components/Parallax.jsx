        ...
        { image: `${Daurah}`, speed: 20 },
        {
          ...
          children: (
            <div className="absolute inset-0 flex items-center justify-center">
              <h1 className="md:text-8xl text-center text-6xl text-white font-thin font-Nanum">Daurah Bernadette</h1>
            </div>
          ),
        },
      ]}
